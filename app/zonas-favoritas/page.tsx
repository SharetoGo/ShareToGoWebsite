...
const SectionHeader = ({
  ...
  <div className={`mb-12 ${className}`}>
    ...
    {sub && <p className="text-gray-500 max-w-2xl text-lg leading-relaxed">{sub}</p>}
  </div>
);
      ...
      <section className="py-24 max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="rounded-[3rem] overflow-hidden relative min-h-[400px] shadow-lg">
            <Image src={GenteFiestaImage} alt="Social" fill className="object-cover" />
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-[#f4f9eb]">
        <div className="max-w-7xl mx-auto px-3">
          ...
          <div className="bg-[#1a1c24] rounded-[3rem] p-10 md:p-16 text-white grid lg:grid-cols-2 gap-12 items-center shadow-2xl">
            <div>
              <h3 className="text-3xl font-bold mb-6 text-[#9dd187]">{t("ev_uni_impact_title")}</h3>
              ...
              <div className="mt-10 grid grid-cols-3 gap-4">
                <div className="text-center">
                  <div className="text-2xl font-bold text-[#9dd187]">{t("ev_uni_stat1_title")}</div>
                  <div className="text-xs opacity-60 mt-1">{t("ev_uni_stat1_text")}</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-[#9dd187]">{t("ev_uni_stat2_title")}</div>
                  <div className="text-xs opacity-60 mt-1">{t("ev_uni_stat2_text")}</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-[#9dd187]">{t("ev_uni_stat3_title")}</div>
                  <div className="text-xs opacity-60 mt-1">{t("ev_uni_stat3_text")}</div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 space-y-32">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2 rounded-[3rem] overflow-hidden shadow-2xl h-[450px] relative group">
              <Image src={AeropuertoImage} alt="Airport" fill className="object-cover" />
