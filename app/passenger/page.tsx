    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div className="mb-8 md:mb-0">
          <Image src={Reservar} alt="Sample Image" className="rounded-lg mt-8" width={500} height={350} data-aos="zoom-y-out"/>

        </div>
        <div>
          <h2 className="text-4xl font-extrabold text-gray-800 mb-6 mt-8">Únete a nosotros como pasajero</h2>
          ...
          <p className="text-gray-700 text-lg mb-6 text-center italic font-bold">
            ...
            <div className="flex items-center space-x-1 pt-5 pl-5">
                ...
                <svg className="w-4 h-4 text-green-400 dark:text-gray-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
                    <path d="M20.924 7.625a1.523 1.523 0 0 0-1.238-1.044l-5.051-.734-2.259-4.577a1.534 1.534 0 0 0-2.752 0L7.365 5.847l-5.051.734A1.535 1.535 0 0 0 1.463 9.2l3.656 3.563-.863 5.031a1.532 1.532 0 0 0 2.226 1.616L11 17.033l4.518 2.375a1.534 1.534 0 0 0 2.226-1.617l-.863-5.03L20.537 9.2a1.523 1.523 0 0 0 .387-1.575Z"/>
                </svg>
            </div>
          </div>
