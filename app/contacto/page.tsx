            ...
            <Card className="p-6">
              <CardContent className="pt-6">
                <div className="flex gap-4">
                  <MessageSquare
                    className="text-[#9dd187] mt-1 flex-shrink-0"
                    size={20}
                  />
                  <div>
