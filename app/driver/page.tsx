      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <p className="text-gray-600 text-lg mb-6">
            Poner a disposición las plazas libres de tu coche en SharetoGo, te aportará ventajas irresistibles. Compartir es la base de nuestra existencia y por ello, premiamos a los conductores.
          </p>
          <p className="text-gray-800 text-lg font-bold mb-2">
            ¿Tienes plazas libres en tu coche?
          </p>
          <p className="text-gray-600 text-lg mb-6">Si quieres ahorrar en gastos, contribuir con el medioambiente y compartir momentos conociendo gente nueva, SharetoGo es lo que necesitas. Gracias a nuestra aplicación, podrás publicar el trayecto que recorres cotidianamente indicando las plazas libres que dispones. Tus futuros compañeros de trayecto se irán uniendo a tu coche.</p>
          <p className="text-gray-600 text-lg mb-6">
          ...
          <div className="flex items-center space-x-1">
            ...
            <div className="flex items-center space-x-1 pt-5 pl-5">
                ...
                <svg className="w-4 h-4 text-gray-400 dark:text-gray-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
                    <path d="M20.924 7.625a1.523 1.523 0 0 0-1.238-1.044l-5.051-.734-2.259-4.577a1.534 1.534 0 0 0-2.752 0L7.365 5.847l-5.051.734A1.535 1.535 0 0 0 1.463 9.2l3.656 3.563-.863 5.031a1.532 1.532 0 0 0 2.226 1.616L11 17.033l4.518 2.375a1.534 1.534 0 0 0 2.226-1.617l-.863-5.03L20.537 9.2a1.523 1.523 0 0 0 .387-1.575Z"/>
                </svg>
            </div>
          </div>
