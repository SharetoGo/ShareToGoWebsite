    ...
    <main className="scroll-smooth">
      ...
      <section className="py-16 md:py-24 bg-linear-to-br from-[#2a2c38] via-[#2a2c38] to-[#1a1c24] overflow-hidden">
        ...
        <motion.div
          ...
          className="absolute top-0 right-0 w-1/2 h-full bg-[#9dd187]/5 skew-x-12 transform translate-x-32 pointer-events-none"
        />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.div
              ...
              viewport={{ once: true }}
              className="absolute top-0 right-0 w-1/3 h-full bg-[#9dd187]/10 skew-x-12 transform translate-x-20 pointer-events-none"
            />
