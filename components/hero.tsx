          ...
          <div className="text-center md:text-left pb-2 md:pb-16 md:w-1/2">
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center" data-aos="zoom-y-out" data-aos-delay="300">
                <div className="pr-8">
                  <a href="#" className="w-full sm:w-auto bg-green-800 hover:bg-green-700 focus:ring-green-300 text-white rounded-lg inline-flex items-center justify-center md:px-6 px-8 py-2.5 dark:bg-green-700 dark:hover:bg-green-600 dark:focus:ring-green-700 transform hover:scale-105 transition-transform">
                ...
                <div className="pr-3">
                  <a href="#" className="w-full sm:w-auto bg-green-800 hover:bg-green-700 focus:ring-green-300 text-white rounded-lg inline-flex items-center justify-center px-8 py-2.5 dark:bg-green-600 dark:hover:bg-green-300 dark:focus:ring-green-500 transform hover:scale-105 transition-transform">
