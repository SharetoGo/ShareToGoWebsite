          ...
          <div className="text-center md:text-left pb-2 md:pb-16 md:w-1/2">
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center justify-center items-center" data-aos="zoom-y-out" data-aos-delay="300">
                <div className="pr-8">
                  <a href="#" className="w-11/12 sm:w-auto bg-green-800 hover:bg-green-700 focus:ring-green-300 text-white rounded-lg inline-flex items-center justify-center md:px-6 px-8 py-2.5 dark:bg-green-700 dark:hover:bg-green-600 dark:focus:ring-green-700 transform hover:scale-105 transition-transform">
                ...
                <div className="mr-8">
                  <a href="#" className="w-11/12 sm:w-auto bg-green-800 hover:bg-green-700 focus:ring-green-300 text-white rounded-lg inline-flex items-center justify-center px-8 py-2.5 dark:bg-green-600 dark:hover:bg-green-300 dark:focus:ring-green-500 transform hover:scale-105 transition-transform">
                    <svg className="mr-3 w-7 h-7" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="google-play" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M325.3 234.3L104.6 13l280.8 161.2-60.1 60.1zM47 0C34 6.8 25.3 19.2 25.3 35.3v441.3c0 16.1 8.7 28.5 21.7 35.3l256.6-256L47 0zm425.2 225.6l-58.9-34.1-65.7 64.5 65.7 64.5 60.1-34.1c18-14.3 18-46.5-1.2-60.8zM104.6 499l280.8-161.2-60.1-60.1L104.6 499z"></path></svg>
                    <div className="text-left">
                      <div className="mb-1 text-xs">Consíguelo en</div>
