      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-between items-center h-16 gap-4">
          ...
          <div className="hidden md:flex items-center justify-end gap-x-6 flex-1 min-w-0">
            ...
            <Link
              href="/funcionamiento"
              className={`${linkBase} ${isActive("/funcionamiento") ? linkActive : ""}`}
            >
            ...
            <Link
              href="/quienes-somos"
              className={`${linkBase} ${isActive("/quienes-somos") ? linkActive : ""}`}
            >
              {t("nav_quienes")}
            </Link>
            ...
            <div
              className="relative"
              onMouseEnter={() =>
                openWithHover(setOpenEspacios, hideEspaciosTO)
              }
              onMouseLeave={() =>
                closeWithDelay(setOpenEspacios, hideEspaciosTO)
              }
            >
              <DropdownMenu
                open={openEspacios}
                onOpenChange={setOpenEspacios}
                modal={false}
              >
                <DropdownMenuTrigger
                ...
                <DropdownMenuContent align="start">
                  ...
                  <DropdownMenuItem asChild>
                    <Link href="/consultoria-de-sostenibilidad">
                      {t("nav_consultoria_sostenibilidad")}
                    </Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem asChild>
                    <Link href="/zonas-favoritas">
            ...
            >
              ...
              >
                ...
                <DropdownMenuContent align="start">
                  <DropdownMenuItem asChild>
                    <Link href="/faqs">{t("nav_faqs")}</Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem asChild>
                    <Link href="/contacto">{t("nav_contacto")}</Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem asChild>
                    <Link href="/contratar">{t("nav_contratar")}</Link>
                  </DropdownMenuItem>
                </DropdownMenuContent>
              </DropdownMenu>
            </div>
                ...
                {languageOptions.map((option) => (
                  ...
                  >
                    ...
                    {currentLanguage === option.code && (
                      <span className="text-xs font-semibold text-[#9dd187]">
                        ●
                      </span>
                    )}
                  </DropdownMenuItem>
        ...
        {isOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 bg-white border-t">
              <Link
                href="/"
                className={`block px-3 py-2 text-sm ${linkBase}`}
              ...
              >
                {t("nav_espacios")}
                <ChevronDown
                  className={`h-4 w-4 transition-transform ${mobileEspaciosOpen ? "rotate-180" : ""}`}
                />
              </button>
              ...
              >
                {t("nav_ayuda")}
                <ChevronDown
                  className={`h-4 w-4 transition-transform ${mobileAyudaOpen ? "rotate-180" : ""}`}
                />
              </button>
