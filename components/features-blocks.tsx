...
<section className="bg-gradient-to-b from-green-100 to-green-600 text-white py-16">
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
          {/* 1st item */}
          <div className="flex flex-col items-center p-6 bg-white bg-opacity-20 rounded-lg shadow-xl transition-transform transform hover:-translate-y-2 hover:scale-105">
            ...
            <p className="text-center">Ahorra dinero y consigue premios irresistibles.</p>
          ...
          <div className="flex flex-col items-center p-6 bg-white bg-opacity-20 rounded-lg shadow-xl transition-transform transform hover:-translate-y-2 hover:scale-105">
            ...
            <p className="text-teal-950 text-center italic mt-4">"La vida sostenible es para gente valiente."</p>
          </div>
          ...
          <div className="flex flex-col items-center p-6 bg-white bg-opacity-20 rounded-lg shadow-xl transition-transform transform hover:-translate-y-2 hover:scale-105">
            ...
            <p className="text-teal-950 text-center italic mt-4 pt-6">"El acto de compartir, te hace más feliz."</p>
          </div>
        </div>
      </div>
    </section>
