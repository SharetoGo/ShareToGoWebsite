...
export default function FeaturesBlocks() {
  return (
    <section className="relative bg-gradient-to-br from-green-200 via-green-500 to-green-800 text-white py-16">
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
          ...
          <div className="relative flex flex-col items-center p-6 bg-white bg-opacity-20 rounded-3xl shadow-xl transition-transform transform hover:-translate-y-2 hover:scale-105">
            ...
            <p className="text-gray-600 text-center italic pt-6 mb-6">"La vida sostenible es para gente valiente."</p>
          </div>
          ...
          <div className="relative flex flex-col items-center p-6 bg-white bg-opacity-20 rounded-3xl shadow-xl transition-transform transform hover:-translate-y-2 hover:scale-105">
            ...
            <p className="text-gray-600 text-center italic mb-5">"El acto de compartir, te hace más feliz."</p>
          </div>
        </div>
      </div>
    </section>
