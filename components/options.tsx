    ...
    <section className="py-16 md:py-24 bg-gradient-to-br from-[#9dd187] to-[#8bc475]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-[#2a2c38]/80 max-w-2xl mx-auto">{t("integra_negocio")}</p>
        </div>
              ...
              <CardContent className="px-4 py-2">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-4">{t("transforma_empleados")}</p>
                    <Link href="/contratar">
              ...
              <CardContent className="px-4 py-2">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-4">{t("contacto_servicio")}</p>
                    <Link href="/contacto">
                      <Button className="bg-[#2a2c38] hover:bg-[#1a1c28] text-white group">
                        {t("contacta_nosotros")}
                        <ArrowRight
