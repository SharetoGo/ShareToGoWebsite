  ...
  return (
    <Card className="overflow-hidden shadow-lg hover:shadow-2xl transition-shadow duration-500 w-full">
      <CardHeader className={cn("p-8", isDriver ? cardVariants.driver : cardVariants.passenger)}>
        ...
        <p
          className={cn(
            "text-xl font-semibold italic pt-2",
            isDriver ? "text-[#2a2c38]/90" : "text-gray-300",
          )}
        >
          &quot;{subtitle}&quot;
        </p>
      ...
      <CardContent className="p-8 bg-white">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="flex flex-col justify-center h-full space-y-6 text-center md:text-left">
            <div>
              <h4 className="text-2xl font-bold text-[#2a2c38] mb-2">
                {slides[currentIndex].title}
              </h4>
              <p className="text-gray-600 leading-relaxed min-h-[6em]">
                  ...
                  {currentIndex === index && (
                    <motion.div
                      className={cn(
                        ...
                        isDriver ? progressVariants.driver : progressVariants.passenger,
                      )}
                      initial={{ width: "0%" }}
                      animate={{ width: "100%" }}
