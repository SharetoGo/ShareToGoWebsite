    ...
    return (
      <div className="bg-gradient-to-br from-gray-50 to-white p-6 rounded-3xl border-2 border-dashed border-gray-200 shadow-sm">
        <div className="flex flex-col items-center justify-center py-8 text-center">
          ...
          <h4 className="text-lg font-bold text-[#2a2c38] mb-2">
            Establece tu Meta de CO₂
          </h4>
          
          <p className="text-sm text-gray-500 mb-6 max-w-md">
            Define un objetivo anual de reducción de CO₂ para tu empresa y 
            monitorea el progreso de tu equipo hacia la sostenibilidad.
          </p>
    ...
    <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm">
      ...
      <div className="mb-6">
        <div className="flex items-end justify-between mb-3">
          ...
          <div className="text-right">
            <p className="text-3xl font-bold text-[#9dd187]">
        ...
        <p className="text-xs text-gray-500 mt-2">
          {remaining > 0 ? (
            <>
              Faltan <span className="font-bold text-[#2a2c38]">{remaining.toFixed(0)} kg</span> para 
              alcanzar la meta ({remainingPercentage.toFixed(0)}%)
            </>
          ) : (
            <span className="text-[#5A9642] font-bold">
              ¡Meta alcanzada! 🎉
            </span>
          )}
        </p>
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="relative p-4 rounded-2xl bg-gradient-to-br from-[#E8F5E0] to-[#F0F8EC] border border-[#9dd187]/20">
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300 leading-relaxed">
                        Un árbol adulto absorbe aproximadamente <span className="text-[#9dd187] font-bold">21 kg de CO₂</span> por año. 
                        Tu empresa ha ahorrado el equivalente a plantar <span className="text-white font-bold">{treesEquivalent} árboles</span>.
                      </p>
                    </div>
                  </div>
                  {/* Arrow */}
          ...
          <p className="text-2xl font-bold text-[#2a2c38] mb-1">
            {treesEquivalent}
          </p>
                ...
                <div className="absolute bottom-full right-0 mb-2 w-64 p-3 bg-[#2a2c38] text-white text-xs rounded-xl shadow-lg z-50 animate-in fade-in duration-200">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300 leading-relaxed">
                        Un coche promedio emite <span className="text-[#9dd187] font-bold">192 kg de CO₂</span> al mes. 
                        Tu reducción equivale a sacar <span className="text-white font-bold">{carsOffRoad} coches</span> de la carretera durante un mes.
                      </p>
                    </div>
                  </div>
                  {/* Arrow */}
                ...
                <div className="absolute bottom-full right-0 mb-2 w-64 p-3 bg-[#2a2c38] text-white text-xs rounded-xl shadow-lg z-50 animate-in fade-in duration-200">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300 leading-relaxed">
                        <Star className="w-3 h-3 inline text-yellow-400 fill-yellow-400" /> 0-49% de la meta<br />
                        <Star className="w-3 h-3 inline text-yellow-400 fill-yellow-400" /><Star className="w-3 h-3 inline text-yellow-400 fill-yellow-400" /> 50-74% de la meta<br />
                        <Star className="w-3 h-3 inline text-yellow-400 fill-yellow-400" /><Star className="w-3 h-3 inline text-yellow-400 fill-yellow-400" /><Star className="w-3 h-3 inline text-yellow-400 fill-yellow-400" /> 75-100% de la meta
                      </p>
