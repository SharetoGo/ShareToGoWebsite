...
export function ReportsView() {
  const reports = [
    { title: "Reporte mensual de sostenibilidad", date: "Dic 2025", type: "PDF", status: "Procesando", url: "" },
    { title: "Informe de huella de carbono mensual", date: "Anual 2025", type: "PDF", status: "Procesando" },
    { title: "Informes Anuales", date: "Trimestre 4", type: "XLSX", status: "Procesando", url: "" },
  ];
